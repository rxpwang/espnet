...
class BeamSearchEarlyStop(torch.nn.Module):
    ...
    def forward(
        ...
        logging.info("Start first pass of beam search with partial data, early stop step: " + str(self.early_stop_step))
